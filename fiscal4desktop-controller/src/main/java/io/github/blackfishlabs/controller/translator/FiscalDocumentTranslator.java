...
import io.github.blackfishlabs.controller.dto.FiscalDocumentDTO;
import io.github.blackfishlabs.controller.dto.document.*;
import io.github.blackfishlabs.controller.dto.document.cofins.COFINSAliqDTO;
import io.github.blackfishlabs.controller.dto.document.cofins.COFINSDTO;
import io.github.blackfishlabs.controller.dto.document.cofins.COFINSNTDTO;
import io.github.blackfishlabs.controller.dto.document.cofins.COFINSOutrDTO;
import io.github.blackfishlabs.controller.dto.document.icms.*;
import io.github.blackfishlabs.controller.dto.document.ipi.IPIDTO;
import io.github.blackfishlabs.controller.dto.document.ipi.IPITribDTO;
import io.github.blackfishlabs.controller.dto.document.pis.PISAliqDTO;
import io.github.blackfishlabs.controller.dto.document.pis.PISDTO;
import io.github.blackfishlabs.controller.dto.document.pis.PISNTDTO;
import io.github.blackfishlabs.controller.dto.document.pis.PISOutrDTO;
...
public class FiscalDocumentTranslator implements Translator<FiscalDocumentDTO, NFLoteEnvio, NFLoteEnvioRetornoDados> {
    ...
    public static String getCalculateID(FiscalDocumentDTO dto) {
        ...
        key.append(StringUtils.leftPad(valueOf(dto.getIde().getNNF()), 9, '0'));
...
//    }
    ...
    public static NFNotaInfoInformacoesAdicionais getNFNotaInfoInformacoesAdicionais(InfAdicDTO dto) {
        ...
        infoAdicionais.setInformacoesComplementaresInteresseContribuinte(dto.getInfCpl().trim());
