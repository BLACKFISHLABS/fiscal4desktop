...
public final class FiscalConstantHelper {
    ...
    public static final String NFCE_ZIP = "-NFCe.zip";
    public static final String NFCE_CANCEL_ZIP = "-NFCe-Cancel.zip";

    public static final String MDFE_ZIP = "-MDFe.zip";
    public static final String MDFE_CANCEL_ZIP = "-MDFe-Cancel.zip";

    public static final String CCE_ZIP = "-CCe.zip";
